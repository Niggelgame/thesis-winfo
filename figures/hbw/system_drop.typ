...
#figure(caption: "HBW Drop model (Retrieve from HBW)")[#align(center)[
  #scale(x: 80%, y: 80%, reflow: true)[#canvas({
    ...
    content(
      ...
      anchor: "north-east", 
      padding: 0.2, 
      text(size: 11pt)[system *HBW drop*]
    )
    ...
    content((3, 1.5), name: "step1", frame: "rect", fill: white, stroke: 2pt, padding: 0.4, align(center)[HBW \ Drop ])

    content((6, 1.5), name: "place1", frame: "circle", fill: white, stroke: 2pt, padding: 0.2, align(center)[HBW \ Dropping])

    content((9, 0), name: "step2", frame: "rect", fill: white, stroke: 2pt, padding: 0.4, align(center)[HBW \ Dropped])

    content((9, -3), name: "step3", frame: "rect", fill: white, stroke: 2pt, padding: 0.4, align(center)[HBW Drop \ Failed])
    ...
    //N content((end-x, -1.5), name: "out2", frame: "circle", fill: white, stroke: 2pt, padding: 0.2, align(center)[AGV at \ `HBW`])
