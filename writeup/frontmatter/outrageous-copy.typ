// Copy of https://typst.app/universe/package/outrageous/ with small modifications
...
#let show-entry(
  ...
  context {
    let prefix = if prefix-transform != none {
      let new-prefix = prefix-transform(entry.element.location(), entry.level, entry.prefix())
