...
#figure(caption: "Parameterized AGV step", placement: none)[
  #align(center)[
  #scale(x: 80%, y: 80%, reflow: true)[#canvas({
    ...
    content("place1.south-east", name: "place1-label", [#v(20pt) #h(45pt) #align(right)[#block[#align(left)[AGV\ at]]]])
