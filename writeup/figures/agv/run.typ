...
#figure(caption: "AGV Move run: " + $"move AGV" circle.small "dock AGV" $, placement: none)[#align(center)[
  #scale(x: 80%, y: 80%, reflow: true)[#canvas({
    ...
    content((2.5, 0), name: "step1", frame: "rect", fill: white, stroke: 2pt, padding: 0.4, align(center)[#h(20pt) #v(20pt)])
    ...
    content("place1.south", name: "place1-label", [#v(25pt) moved])
    ...
    content("out1.south-east", name: "out1-label", [#v(25pt) #h(20pt) #block[AGV\ at]])
