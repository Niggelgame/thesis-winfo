...
#figure(caption: "AIQS Drop steps")[
#align(center)[
  #scale(x: 80%, y: 80%, reflow: true)[#canvas({
    ...
    content((3, 0), name: "step1", frame: "rect", fill: white, stroke: 2pt, padding: 0.4, align(center)[AIQS \ Drop ])

    content((6, 0), name: "place1", frame: "circle", fill: white, stroke: 2pt, padding: 0.2, align(center)[AIQS \ Dropping])
...
#align(center)[
  #scale(x: 80%, y: 80%, reflow: true)[#canvas({
    ...
    content(
      ...
      anchor: "north-east", 
      padding: 0.2, 
      text(size: 11pt)[step *AIQS dropped*]
    )
    ...
    content((end-x, -1.5), name: "out2", frame: "circle", fill: white, stroke: 2pt, padding: 0.2, align(center)[AGV at \ `AIQS`])
...
#align(center)[
  #scale(x: 80%, y: 80%, reflow: true)[#canvas({
    ...
    content(
      ...
      anchor: "north-east", 
      padding: 0.2, 
      text(size: 11pt)[step *AIQS drop failed*]
    )
    ...
    content((9,0), name: "step3", frame: "rect", fill: white, stroke: 2pt, padding: 0.4, align(center)[AIQS Drop \ Failed])
