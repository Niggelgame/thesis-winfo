...
#figure(caption: "AIQS Perform Quality Checking model")[#align(center)[
  #scale(x: 80%, y: 80%, reflow: true)[#canvas({
    ...
    content(
      ...
      anchor: "north-east", 
      padding: 0.2, 
      text(size: 11pt)[system *AIQS check quality*]
    )
    ...
    content((3, 1.5), name: "step1", frame: "rect", fill: white, stroke: 2pt, padding: 0.4, align(center)[AIQS \ Check \ Quality ])

    content((6, 1.5), name: "place1", frame: "circle", fill: white, stroke: 2pt, padding: 0.2, align(center)[AIQS \ Checking ])

    content((9, 1.5), name: "step2", frame: "rect", fill: white, stroke: 2pt, padding: 0.4, align(center)[AIQS \ Checked \ Quality ])

    content((9, -1.5), name: "step3", frame: "rect", fill: white, stroke: 2pt, padding: 0.4, align(center)[AIQS \ Check \ Failed])
